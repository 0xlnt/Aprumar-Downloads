...
No Windows, execute o instalador `.exe`. No Linux, baixe o `.AppImage`, marque-o como executável e abra-o. Quem usa a versão 0.3.0 precisa instalar a 0.4.0 manualmente uma vez. Da 0.4.0 em diante, o aplicativo verifica novas releases ao iniciar e periodicamente, avisa quando encontra uma versão, baixa em segundo plano e oferece instalação ao reiniciar ou fechar. O pacote Linux `.tar.gz` não tem atualização automática: use o AppImage para esse recurso.
